...
function Contact() {
    return (
        <div className={styles.contact_layout} id="contact">
            ...
            <div className="row">
                <div className="col-6" style={{ maxWidth: '47.25%' }}>
                    <FadeInLeftWhenVisible>
                        <iframe
                ...
                <div className="col-6 d-flex flex-column bg-light text-dark ml-4" style={{ maxWidth: '47.25%' }}>
                    <FadeInRightWhenVisible>
                        <span className="mt-3">
                            <b>Address</b>
                        </span>
                        <span className="mt-3 mb-3" style={{ maxWidth: '98%' }}>
